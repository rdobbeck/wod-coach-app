/**
 * The coach's usual prices, in cents. A single session is $140, first or not.
 * Packages bring it down to $125, $119, $100 and $95 a session and are valid 4
 * months. At the gym pod the client books the pod separately (about $15-20) and
 * the coach meets them there, so the pod is not part of what the coach charges.
 */
...
export const USUAL_CATALOG: CatalogItem[] = [
  ...
  { name: "Gym pod session", description: "60 minutes in person. You book the pod yourself (about $15-20) and I meet you there.", priceCents: 14_000, sessions: 1 },
  { name: "Off-site session", description: "60 minutes, I come to you.", priceCents: 14_000, sessions: 1 },
